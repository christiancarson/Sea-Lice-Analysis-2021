...
for (i in 1:nloop) {
  ...
  coloursloop<-c("grey20","grey40","grey60","grey80")
  ...
  lines(siteagg3$Group.date, siteagg3$total.prevalence, lty=linetype[1], pch=plotchar[1], lwd = 2, type ="o", col = "grey20", cex =1.5)
  lines(siteagg3$Group.date, siteagg3$motile.prevalence, lty=linetype[2], pch=plotchar[2], lwd = 2, type ="o", "grey40", cex =1.5 )
  lines(siteagg3$Group.date, siteagg3$chalimus.prevalence, lty=linetype[3], pch=plotchar[3], lwd = 2, type ="o", col = "grey60", cex =1.5 )
  lines(siteagg3$Group.date, siteagg3$copepodid.prevalence, lty=linetype[4], pch=plotchar[4], lwd = 2, type ="o", col = "grey80", cex =1.5 )
  axis(side = 1, at = 1:9,
